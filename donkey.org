...
# Time-stamp: <2024-07-03 23:24:44 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2024-07-03 Mi 23:24]
   | Headline                           | Time       |          |          |         |
   |------------------------------------+------------+----------+----------+---------|
   | *Total time*                       | *2d 22:05* |          |          |         |
   |------------------------------------+------------+----------+----------+---------|
   | Donkey                             | 2d 22:05   |          |          |         |
   | \_  Components [0/1]               |            | 2d 22:05 |          |         |
   | \_    Database [1/2]               |            |          |     8:39 |         |
   | \_      JSON without the Argonauts |            |          |          |    0:30 |
   | \_      Testing                    |            |          |          |    2:19 |
   | \_    Server [0/0]                 |            |          |    14:36 |         |
   | \_      Webservice [0/0]           |            |          |          |    8:27 |
   | \_    Agent [0/2]                  |            |          | 1d 22:50 |         |
   | \_      Configuration              |            |          |          |    1:27 |
   | \_      Probes [0/0]               |            |          |          | 1d 6:48 |
   #+END:
** Diary
** Features [0/0]
   :PROPERTIES:
...
**** TODO Probes [0/0]
     ...
     :END:
     :LOGBOOK:
     CLOCK: [2024-07-02 Di 19:36]--[2024-07-03 Mi 20:24] => 24:48
